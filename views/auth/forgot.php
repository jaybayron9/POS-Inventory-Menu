<div id="forgot-div" class="hidden flex items-center justify-center min-h-screen">
    <div class="px-8 py-6 mt-4 text-left bg-white shadow-lg rounded-md">
        <h3 class="text-2xl font-bold text-center mb-4">Forgot Your Password?</h3>
        ...
        <form id="forgot-form">
            <!-- Alert -->
            <div id="forgot-alert" class="hidden flex p-3 mb-4 mt-2 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800" role="alert">
