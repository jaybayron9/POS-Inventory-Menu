        ...
        <fieldset class="grid grid-cols-4 gap-6 p-6 rounded-md bg-gray-100">
            ...
            <div class="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
                <div class="col-span-full sm:col-span-3">
                    <label for="Bussiness Name" class="text-sm text-gray-700">Bussiness Name</label>
                ...
                <div class="col-span-full sm:col-span-3">
                    <label for="Bussiness Name" class="text-sm text-gray-700">Address</label>
                ...
                <div class="col-span-full sm:col-span-3">
                    <label for="Phone No." class="text-sm text-gray-700">Phone No.</label>
                ...
                <div class="col-span-full sm:col-span-3">
                    <label for="email" class="text-sm text-gray-700">Facebook URL</label>
                ...
                <div class="col-span-full sm:col-span-3">
                    <label for="Business logo" class="text-sm text-gray-700">Business logo</label>
