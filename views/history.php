...
<section class="container mx-auto px-5">
    <div class="flex my-4">
        ...
        <div class="ml-auto mr-3 hover:bg-gray-200 rounded">
        ...
        <div class="hover:bg-gray-200 rounded-full">
            <a href="#" id="clear-history" title="Reset history" class="reset-sale">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        ...
                        <td>
                            <?php 
                                ...
                                for ($i = 0; $i < count($name); $i++) {
                                    echo "<span class='bg-gray-200 rounded-l m-0 px-2'>" 
                                            . $name[$i] . 
                                        "</span>";
                                    echo "<span class='bg-gray-200 m-0 px-1 bg-sky-300'>" 
                                            . $quantity[$i] . 
                                        "</span>";
                                    if (empty($price[$i])) {
                                        echo "<span class='bg-gray-200 rounded-r m-0 px-1 bg-green-300'></span>";
                                    } else {
                                        echo "<span class='bg-gray-200 rounded-r m-0 px-1 bg-green-300'>" 
                                                . $price[$i] . 
                                            "</span>";
                                    }
