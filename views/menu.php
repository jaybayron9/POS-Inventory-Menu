        ...
        <div class="col-span-1 mx-4 mb-2 rounded-md shadow-lg bg-gray-50 sticky top-6">
            <div class="px-2 mb-3">
                            ...
                            <div id="customer-label">
                                ...
                                <div data-popover id="customer-profile" role="tooltip" class="absolute inline-block text-sm transition-opacity duration-300 border rounded shadow-xl opacity-0 w-72 bg-white border-gray-600 text-gray-700">
                                    <div class="p-2 space-y-1">
                                        <p id="info-customer" class="font-semibold text-medium text-dark text-lg uppercase text-center rounded shadow-md shadow-gray-400"> 
                                        </p>
                ...
                <div class="flex items-center justify-left" data-drawer-hide="drawer-backdrop" aria-controls="drawer-backdrop">
                    ...
                    <!-- print receipt -->
                    <button id="print-receipt" title="print receipt" class="ml-auto border rounded-md border-gray-500 hover:border-gray-50 rounded-md mt-2 flex px-3 py-1 mr-3 bg-gradient-to-r from-red-500 to-gray-700 text-white hover:text-red-200">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    ...
                    <!-- place order -->
                    <button id="send-request" title="Place order" class="hidden ml-auto border rounded-md border-gray-500 hover:border-gray-50 rounded-md mt-2 flex px-3 py-1 mr-3 bg-gradient-to-r from-red-500 to-gray-700 text-white hover:text-red-200">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
