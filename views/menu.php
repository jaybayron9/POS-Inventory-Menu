            ...
            <div class="col-span-1 mx-4 mb-2 rounded-lg shadow-lg bg-gray-50 sticky top-6" style="height: fit-content; background-image: url('public/storage/eximage/bg3.png'); background-repeat: repeat; background-size: 25px 25px;">
                <div class="px-2 mb-3">
                    ...
                    <div class="flex items-center justify-left" data-drawer-hide="drawer-backdrop" aria-controls="drawer-backdrop">
                        ...
                        <button id="refresh-table" title="Refresh" class="ml-auto border border-gray-500 rounded-full hover:border-gray-50 mt-4 text-white font-medium hover:text-red-300 p-1 bg-gradient-to-r from-red-500 to-gray-700 rounded-full">
                        ...
                        <!-- print receipt -->
                        <button id="print-receipt" title="print receipt" class="ml-auto border rounded-md border-gray-500 hover:border-gray-50 rounded-md mt-4 flex px-3 py-2 mr-2 bg-gradient-to-r from-red-500 to-gray-700 text-white hover:text-red-200">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
